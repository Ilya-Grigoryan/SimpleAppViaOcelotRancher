...
kubectl create configmap gateway-nginx-app-config --from-file=gateway-nginx-app.conf;kubectl apply -f gateway-nginx-deployment.yaml;kubectl apply -f gateway-nginx-service.yaml
...
kubectl delete configmap gateway-nginx-app-config